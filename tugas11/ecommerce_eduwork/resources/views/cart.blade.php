...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('products') }}" class="btn btn-outline-secondary btn-sm">&larr; Kembali Belanja</a>
    </div>

    @if(empty($cartItems))
        <div class="alert alert-warning p-5 rounded-4 shadow-sm text-center">
            <h4 class="fw-bold">Keranjang belanjamu kosong.</h4>
            <a href="{{ route('products') }}" class="btn btn-warning btn-sm mt-2 fw-bold">Lihat Produk</a>
        </div>
    @else
        <div class="row">
