...
if(isset($_POST['submit'])){
    ...
    (nama, harga, deskripsi, kategori, stok, gambar)
    VALUES
    ('$nama','$harga','$deskripsi', '$kategori', '$stok','$gambar')");
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-4">
                        <select name="kategori" class="form-control">
                            ...
                            ?>
                                <option value="<?= $dataKategori['kategori']; ?>">
        ...
        <div class="modal-content rounded-4">
            ...
            <div class="modal-body">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="nama" class="form-control mb-3" placeholder="Nama Produk">

                    <input type="text" name="produk" class="form-control mb-3" placeholder="Produk">
